...
const Hero = () => {
  ...
  return (
    ...
    <div className='container relative' ref={parallaxRef}>
        ...
        <img src={curve} className='absolute top-full left-0 w-full xl:-ml-2'
            width={624}
            height={28}
            alt='Curve'
        />
        ...
        md:max-w-5xl xl:mb-24'>
            <div className='relative z-1 p-0.5 rounded-2xl bg-conic-gradient'>
                ...
                <div  className='h-[1.4rem] bg-n-10 rounded-t-[0.9rem]'/>
                    ...
                    <Generating className="absolute left-4 right-4 bottom-5 md:left-1/2 md:right-auto md:bottom-8 md:w-[31rem] md:-translate-x-1/2 transform"/>

                    <ScrollParallax isAbsolutelyPositioned>
                        <ul className='hidden absolute -left-[2.5rem] bottom-[7.5rem] px-1 py-1 bg-n-9/40 backdrop-blur border border-n-1/10 rounded-2xl md:flex md:flex-col xl:-left-[7.5rem] xl:flex xl:flex-row'>
