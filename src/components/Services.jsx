        ...
        <div className='container'>
            ...
            <div className='relative'>
                ...
                <div className='relative z-1 max-w-[17rem] ml-auto'>
                    ...
                    {/* translate-x is not working here */}
                <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2 transform"/>
